    ...
    <main className="min-h-screen bg-[#FBFBFA] text-[#1A1A1A] flex flex-col justify-between selection:bg-[#E5E5E0]">
      ...
      <section className="w-full max-w-3xl mx-auto px-6 py-16 flex flex-col gap-8 my-auto">
        ...
        <div className="space-y-6 text-[#4A4A45] leading-relaxed text-sm sm:text-base">
          <div>
            <h2 className="text-lg font-semibold text-[#111111] mb-2">1. Ketentuan Akun</h2>
            <p>
              Pengguna bertanggung jawab penuh atas kerahasiaan kredensial akun masing-masing. Penyalahgunaan akun untuk aktivitas yang merugikan sekolah akan dikenakan sanksi tata tertib.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-[#111111] mb-2">2. Integritas Data Akademik</h2>
            <p>
              Segala bentuk manipulasi nilai, absensi, atau dokumen resmi melalui sistem adalah pelanggaran berat yang akan ditindaklanjuti secara hukum dan disiplin akademik.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-[#111111] mb-2">3. Batasan Akses</h2>
            <p>
              Akses terhadap sistem dibatasi sesuai dengan peran yang diberikan (Siswa, Guru, Staf, Admin). Pengguna dilarang mencoba menembus hak akses yang bukan wewenangnya.
            </p>
          </div>
        </div>
      </section>
